...
/**
 * @title AnnotationMarketplaceMock
 * @notice Simplified version of AnnotationMarketplaceHTS for local testing (ERC20-based).
 */
contract AnnotationMarketplaceMock is Ownable, ReentrancyGuard {
    IERC20 public token;
    ...
    event ProjectCreated(uint256 indexed projectId, address indexed client, uint256 totalTasks, uint256 rewardPerTask);
    ...
    function createProject(
        ...
        emit ProjectCreated(projectId, msg.sender, totalTasks, rewardPerTask);
        return projectId;
    }
